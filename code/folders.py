...
### Municipalities' area
municipalities_area_file = os.path.join(RAW_DATA, "municipalities_area.xlsx")
...
costa_rican_municipalities_distance_matrix_stata = os.path.join(FINAL_DATA, "distances.dta")
